...
INSERT IGNORE INTO `PREFIX_hook` (`id_hook`, `name`, `title`, `description`, `position`) VALUES
  ...
  (NULL, 'actionExportOrder', 'Allows you to modify the csv generated by the order export in the administration', 'This hook is executed before the csv output of the commands', '1')
;
