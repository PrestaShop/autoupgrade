...
/* PHP:add_column('stock_available', 'physical_quantity', 'INT NOT NULL DEFAULT \'0\' AFTER `quantity`'); */;
/* PHP:add_column('stock_available', 'reserved_quantity', 'INT NOT NULL DEFAULT \'0\' AFTER `physical_quantity`'); */;
