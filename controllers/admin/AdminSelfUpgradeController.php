...
class AdminSelfUpgradeController extends ModuleAdminController
{
    ...
    private function addUIAssets(Request $request)
    {
        ...
        if ($assetsEnvironment->isDevMode()) {
            ...
            $this->content .= $twig->render('@ModuleAutoUpgrade/module-script-tag.html.twig', ['module_type' => true, 'src' => $assetsBaseUrl . '/js/autoupgrade.js?version=' . $this->module->version]);
        }
    }
}
