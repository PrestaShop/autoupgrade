  ...
  args: {
    ...
    requirements: {
      ...
      errors: [
        ...
        {
          message:
            'PrestaShop\'s caching features needs to be disabled. Disable caching features in <a class="link">Advanced parameters > Performance > Caching</a>',
        },
        {
          message:
      ...
      warnings: [
        {
          message:
            'Your current version of the module is out of date. Update now <a class="link">Modules > Module Manager > Updates</a>',
        },
        {
          message:
        ...
        {
          message:
            'Some core files have been altered, customization made on these files will be lost during the update. See the list in <a class="link">Advanced parameters > Information</a>',
        },
      ],
    },
  },
