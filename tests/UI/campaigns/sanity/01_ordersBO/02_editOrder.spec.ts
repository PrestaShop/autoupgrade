...
Logout from the BO
*/
test('BO - Orders - Orders : Edit Order BO', async ({page}) => {
  await test.step('PRE-TEST: Setup SMTP config', async () => {
    // Pre-Condition: Setup config SMTP
    await setupSmtpConfigTest(page);
  });
  ...
  await test.step('should go to the \'Orders > Orders\' page', async () => {
