...
class UpgradeComplete extends AbstractTask
{
    public function run()
    {
        ...
        if ('archive' != $this->container->getUpgradeConfiguration()->get('channel') && file_exists($this->container->getFilePath()) && unlink($this->container->getFilePath())) {
        ...
        if ('directory' != $this->container->getUpgradeConfiguration()->get('channel') && file_exists($this->container->getProperty(UpgradeContainer::LATEST_PATH)) && FilesystemAdapter::deleteDirectory($this->container->getProperty(UpgradeContainer::LATEST_PATH))) {
