...
class UpgradePage
{
    ...
    private function _getJsErrorMsgs()
    {
        ...
        $ret = [
            ...
            // End of upgrader
            38 => $translator->trans('Impossible to write the image /img/logo.jpg. If this image already exists, please delete it.', [], $translationDomain),
            39 => $translator->trans('The uploaded file exceeds the upload_max_filesize directive in php.ini', [], $translationDomain),
            ...
            41 => $translator->trans('The uploaded file was only partially uploaded', [], $translationDomain),
            ...
            44 => $translator->trans('Failed to write file to disk', [], $translationDomain),
            45 => $translator->trans('File upload stopped by extension', [], $translationDomain),
            46 => $translator->trans('Cannot convert your database\'s data to utf-8.', [], $translationDomain),
            47 => $translator->trans('Invalid shop name', [], 'Install'),
            48 => $translator->trans('Your firstname contains some invalid characters', [], 'Install'),
            49 => $translator->trans('Your lastname contains some invalid characters', [], $translationDomain),
            50 => $translator->trans('Your database server does not support the utf-8 charset.', [], 'Install'),
            51 => $translator->trans('Your MySQL server does not support this engine, please use another one like MyISAM', [], $translationDomain),
            52 => $translator->trans('The file /img/logo.jpg is not writable, please CHMOD 755 this file or CHMOD 777', [], $translationDomain),
            53 => $translator->trans('Invalid catalog mode', [], $translationDomain),
