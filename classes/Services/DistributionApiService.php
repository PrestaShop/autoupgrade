...
class DistributionApiService
{
     ...
     *
     * @return array<string, array{display_name: string, tab: string, description: string, author: string, version: string, prestashop_min_version: string|null, prestashop_max_version: string|null, download_url: string, icon: string}>
     *
