...
class UpgradeFileNames
{
    ...
    const MODULE_SOURCE_PROVIDER_CACHE_PRESTASHOP_ARCHIVE = 'moduleSourcesPrestaShopArchive.cache';
    ...
    public static $update_tmp_files = [
        ...
        'MODULE_SOURCE_PROVIDER_CACHE_PRESTASHOP_ARCHIVE' => self::MODULE_SOURCE_PROVIDER_CACHE_PRESTASHOP_ARCHIVE,
