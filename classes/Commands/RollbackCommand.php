...
class RollbackCommand extends AbstractCommand
{
     ...
     * @var string
     */
    protected static $defaultName = 'rollback:start';
    ...
    protected function configure(): void
    {
        $this
            ...
            ->setHelp(
                ...
                'See https://devdocs.prestashop-project.org/8/basics/keeping-up-to-date/upgrade-module/upgrade-cli/ for more details'
            )
            ->addOption('admin-dir', 'ad', InputOption::VALUE_REQUIRED, 'The admin directory name.')
            ->addOption('backup', 'b', InputOption::VALUE_REQUIRED, 'Specify the backup name to restore (this can be found in your folder <admin directory>/autoupgrade/backup/)');
}
