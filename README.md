...
| `backup:create`                             | `max_files_per_call`                          | `--max-files-per-call`               | `400`                                                                                   | Number of files to handle in a single call to avoid timeouts                                                                                                                           |
| `backup:create`                             | `max_file_size`                               | `--max-file-size`                    | `15728640`                                                                              | Max file size allowed in backup                                                                                                                                                        |
| `backup:create`                             | `max_sql_size_to_write_per_call`              | `--max-sql-size-to-write-per-call`   | `4194304`                                                                               | Kind of reference for SQL file creation, giving a file size before another request is needed                                                                                           |
